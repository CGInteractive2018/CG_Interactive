...
public class PlayerMove : MonoBehaviour {
    ...
    public GameObject target; //1Pの3人称のカメラを設定
    private float varX;
    private float varZ;
    ...
    void FixedUpdate(){
        ...
        Vector3 cameraForward = Vector3.Scale(target.transform.forward, new Vector3(1, 0, 1)).normalized;

        // 方向キーの入力値とカメラの向きから、移動方向を決定
        Vector3 moveForward = cameraForward * varZ + target.transform.right * varX;
